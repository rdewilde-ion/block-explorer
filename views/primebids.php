...
<!--			<td>--><?php //echo \lib\Helper::formatION(PRIME_BID_AMOUNT); ?><!--</td>-->
<!--		</tr>-->
<!--		<tr>-->
...
<!--				<td >--><?php //echo \lib\Helper::formatION($bids['bid'], $addressTagMap) ?><!--</td>-->
<!--				<td >--><?php //echo $bids['percent'] ?><!-- %</td>-->
<!--				<td >--><?php //echo $bids['rank'] ?><!--</td>-->
<!--				<td class="text-right">--><?php //echo \lib\Helper::formatION($bids['balance'], $addressTagMap) ?><!--</td>-->
<!--			</tr>-->
<!--		--><?php //} ?>
<!--	</table>-->
